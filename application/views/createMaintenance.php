                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action=" <?php echo site_url().'maintenance/create'; ?>" method="POST">
                                        <div class="form-group">
                                            <label>Id Inventaris</label>
                                            <select class="form-control" name="id_inventaris">
                                            <?php foreach ($inventaris as $bar) {?>
                                                <option value="<?php echo $bar['id_inventaris'] ?>">
                                                    <?php echo $bar['id_inventaris']." -- ".$bar['jenis'];
                                                    ?>
                                                </option>
                                            <?php } ?>
                                            </select>
